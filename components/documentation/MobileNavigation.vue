<template>
  <div class="relative flex border-b border-accent bg-neutral-1 lg:hidden">
    <button type="button" class="my-5 flex text-xl" aria-label="Open navigation" @click="setIsOpen(true)">
    ...
    <ClientOnly>
      <Dialog :open="isOpen"
        ...
        aria-label="Navigation" @close="setIsOpen">
        <DialogPanel class="min-h-full w-full max-w-xs bg-neutral-2 px-4 pb-12 pt-5 sm:px-6">
          <div class="flex items-center">
            <button type="button" aria-label="Close navigation" @click="setIsOpen(false)">
