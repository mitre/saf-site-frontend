            ...
            <div v-if="isLoaded">
                <div class="">
                    ...
                    <div class="py-10">
                        <div class="mx-auto max-w-7xl">
                            ...
                            <div class="flex flex-col items-center w-full">
                                ...
                                <div class="grid grid-cols-1 items-center">
                                    <div class="mx-auto grid w-full max-w-xl grid-cols-5 gap-4">
                                        <div v-for="element in toHDF">
                                            <div
                                                class="w-[60px] h-[60px] md:w-[100px] md:h-[100px] backdrop-opacity-10 backdrop-invert bg-white/30 p-2 rounded text-center flex justify-center items-center">
                                ...
                                <div
                                    class="w-[60px] h-[60px] md:w-[100px] md:h-[100px] object-contain object-center backdrop-opacity-10 backdrop-invert bg-white/30 p-2 rounded text-center flex justify-center items-center">
                    ...
                    <div class="py-10">
                        <div class="mx-auto max-w-7xl">
                            <div class="mb-5">
                                <h2 class="text-3xl font-bold tracking-tight dark:text-gray-100">Convert To These Common
                                    Tools
                                </h2>
                                <p class="mt-6 text-lg leading-8 dark:text-dark-text">Lorem ipsum dolor sit amet,
                                    consectetur
