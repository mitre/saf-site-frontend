<template>
  <div class="bg-light-backdrop-primary dark:bg-dark-backdrop-primary px-6">
    <div class="relative py-24 sm:py-32 lg:py-40">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
          <p class="mt-2 text-3xl font-bold tracking-tight text-light-header dark:text-dark-header sm:text-4xl">The SAF Is
          </p>
        </div>
