<template>
  <div>
    <Head>
      <Title>Example OHDF Schema</Title>
      <Meta name="description" content="Example OHDF Schema" />
    </Head>
    <div>
      <Header />
      <div
          ...
          <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto my-5 max-w-7xl mx-auto">
              <h1 class="text-center text-5xl font-bold text-header mb-5">
                <strong
                  >Example Ubuntu 16.04 STIG baseline requirement
                  V-75443</strong
                >
              </h1>
...
const getJsonData = async () => {
  jsonData.value = await useAsyncData('getJsonContentByPage', () =>
    GqlGetJsonContentByPage({pageName: 'Normalize-Example-Schema'})
