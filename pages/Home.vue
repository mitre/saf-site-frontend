...
<template>
  <div> <Header /></div>
  <div class="relative bg-gray-50 dark:bg-dark-bg  overflow-hidden h-screen">
    <div class="hidden sm:block sm:absolute sm:inset-y-0 sm:h-full sm:w-full" aria-hidden="true">
      <div class="relative h-full max-w-7xl mx-auto">
        <!-- <svg class="absolute right-full transform translate-y-1/4 translate-x-1/4 lg:translate-x-1/2" width="404" height="784" fill="none" viewBox="0 700 404 404">
          <defs>
        ...
        <svg class="absolute left-full transform translate-y-3/4 translate-x-1/4 md:-translate-y-1/2 lg:-translate-x-1/2" width="612" height="784" fill="none" viewBox="0 100 300 784">
          <defs>
      ...
      <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            {{ ' ' }} -->
            <span class="block text-blue-600 xl:inline">Security Automation Framework</span>
          </h1>
