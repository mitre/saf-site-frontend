      ...
      <div class="bg-white dark:bg-dark-bg min-h-screen h-full">
        <div class ="relative w-full px-6 py-12 lg:pt-16 lg:pb-28"> 
          <div v-if="isLoaded" class="md:flex">
            ...
            <div id="Content Area" class="flex-1 items-center justify-center  ml-auto min-w-0 px-6 py-12 max-w-3xl sm:shadow-2xl shadow-slate-700/10 dark:shadow-slate-100/10 ring-3 ring-gray-900/5">
              ...
              <div id="Schedule for schedules Mobile" class="relative pointer-events-auto order-2 pt-8 pr-6 md:hidden">
                <div  class="">
                        ...
                        <div class="flex-0 pl-4">
                          ...
                          <dl class="mt-2 flex flex-col text-gray-500 xl:flex-row">
                            <div class="flex items-start space-x-3 pl-1">
                              ...
                              <dd>
                                <time :datetime="schedule.date"> {{formatDate(schedule.date)}} at {{formatTime(schedule.date)}} EST </time>
                              </dd>
                            </div>
                          </dl>
                        </div>
                        <div class="right-2 top-0 ">
                          <a type="button" :href="schedule.link" target="_blank" class="inline-flex items-center rounded-full border border-transparent bg-blue-600 sm:px-3 sm:py-1.5 px-1 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Sign Up</a>
                        </div>
                      </li>
                    </ol>
                  </div>
                  <div v-else class="relative max-w-sm mt-6 pl-2 dark:text-dark-text"> 
                    <p> Sorry there are no upcoming schedules at this time. If you would like to host a schedule please contact saf@groups.mitre.org </p>
                  </div>
                </div>
                <hr class="mt-4 w-full" />
              </div>
              <div id="Embeded Videos" class="sm:flex-1 order-1 md:max-w-3xl pt-9">
                ...
                <div v-else>
                  <p class="relative max-w-sm mt-6 pl-2 dark:text-dark-text"> Courses are being updated. Check back later! </p>
                </div>
              </div>
            </div>
            <div id="Schedule for schedules" class="sticky top-28 pointer-events-auto pr-6 hidden max-w-xl min-w-min pl-4 md:block h-fit">
              <div  class="relative">
                <h2 class="text-lg font-semibold text-gray-900 sm:pl-3 pt-6 dark:text-white">Upcoming Classes</h2>
                <div v-if="schedules.length" class="lg:grid lg:grid-cols-2">
                  <ol class="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8">
