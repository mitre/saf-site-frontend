      ...
      <div
        ...
        <div class="flex justify-left md:flex-1 lg:w-0 lg:flex-1">
          <a href="/">
            ...
            <!-- <img class="h-8 w-auto sm:h-10" src="./public/saf_logo.svg" alt="" /> -->
        ...
        <div class="hidden md:flex items-center justify-end flex-1 pr-2 md:w-0">
          ...
          <div id="theme-toggle" type="button" 
            ...
            <svg id="theme-toggle-light-icon" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hidden" fill="none"
              viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round"
...
export default {
  ...
  methods: {
    ...
    enableDarkMode() {
      ...
      // document.getElementById('themeMobileMenuButton').innerHTML = "Dark Mode"
    ...
    disableDarkMode() {
      ...
      //document.getElementById('themeMobileMenuButton').innerHTML = "Light Mode"
      this.htmlCurrent = this.htmlLight
    },
    toggleTheme() {
      if (this.darkMode || localStorage.getItem("user-theme") === 'dark') {
        this.disableDarkMode()
        localStorage.setItem('user-theme', 'light');
      } else {
        this.enableDarkMode()
      ...
      localStorage.setItem('userDidOverrideColor', 'true');
  ...
  mounted() {
    const haveCustomColorScheme = localStorage.getItem("userDidOverrideColor") === 'true'
    if (haveCustomColorScheme) {
      console.log(localStorage.getItem("color-theme"))
      localStorage.getItem("user-theme") === 'dark' ? this.enableDarkMode() : this.disableDarkMode()
    } else {
