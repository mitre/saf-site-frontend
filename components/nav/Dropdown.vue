  ...
  <Popover v-slot="{ open }" class="relative">
    ...
    <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
      ...
      <PopoverPanel class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
        <div class="overflow-hidden rounded-lg shadow-lg ring-dropshadow ring-opacity-5">
          <div class="relative grid gap-6 rounded-xl border border-accent bg-neutral-1 px-5 py-6 sm:gap-8 sm:p-8">
