    ...
    <div class="overflow-hidden mx-auto max-w-5xl bg-neutral-2  shadow sm:rounded-lg mt-8">
      ...
      <div class="sm:flex">
        <div class="flex-1 border-t border-accent ">
          <div>
            <div class="bg-neutral-1  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-b">
            ...
            <div class="bg-neutral-2  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-b">
