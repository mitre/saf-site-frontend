<template>
  ...
  <div>
    <Header />
    <div class="relative bg-neutral-1  min-h-screen h-full pt-4 px-4 sm:px-6 lg:px-8">
      <div v-if="isLoaded">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="text-xl font-bold text-header ">Harden</h1>
            <p class="mt-2 text-sm text-base ">These open-source community-based hardening
            ...
            hardening: guidance.attributes.hardening.data.map((harden) => ({
              ...
              platform: {
                ...
                icon: {
                  ...
                  alt: harden.attributes.platform.data.attributes.icon.data ? harden.attributes.platform.data.attributes.icon.data.attributes.alternativeText : null,
                }
              },
              partner: {
                ...
                icon: {
                  ...
                  alt: harden.attributes.partner.data.attributes.icon.data ? harden.attributes.partner.data.attributes.icon.data.attributes.alternativeText : null,
                }
              }
            })),
          }))
