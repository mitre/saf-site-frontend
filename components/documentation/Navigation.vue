<template>
  <div>
    ...
    <div class="max-w-8xl pointer-events-auto sticky top-0 z-50 mb-10 mr-5 bg-neutral-2">
      ...
      <button type="button"
        ...
        <svg width="24" height="24" fill="none" aria-hidden="true" class="mr-3 inline flex-none">
        ...
        Documentation search...<span class="ml-auto flex-none pl-3 text-xs font-semibold">Ctrl K</span>
      </button>
    </div>
