<template>
  <div class="sticky top-0 z-50 w-full">
    <Popover
      class="border-b-2 border-gray-100 bg-white dark:border-gray-500 dark:bg-dark-bg"
    >
      <div class="max-w-8xl mx-auto px-4 sm:px-1">
        ...
        >
          <div class="justify-left flex md:flex-1 lg:w-0 lg:flex-1">
            <NuxtLink to="/">
              ...
              >
                ...
                >
                  <g
                    ...
                    transform="translate(5.200000, 0.000000)"
                    fill="#1a73e8"
                    fill-rule="nonzero"
                  >
                    <path
                  ...
                  <g
                    id="Group"
                    transform="translate(14.500000, 14.000000)"
                    fill-rule="nonzero"
                  >
            ...
            <NuxtLink to="/" class="flex">
              <h1
                class="whitespace-nowrap p-2 text-2xl font-extrabold tracking-tighter text-gray-900 dark:text-MITRE-silver md:text-3xl xl:text-4xl"
              >
          ...
          <div
            ...
            class="-my-2 -mr-2 flex sm:pr-3 md:hidden"
          >
            <div class="flex flex-1 justify-end px-2 lg:ml-6">
              <div class="w-1/8 max-w-lg lg:max-w-xs">
                ...
                <div class="relative">
                  ...
                  <input
                    id="search"
                    name="search"
                    class="block w-0 rounded-md border border-transparent bg-white py-3 pl-5 pr-4 leading-5 text-gray-300 placeholder-gray-400 hover:bg-gray-200 focus:w-full focus:border-white focus:bg-white focus:pl-10 focus:text-gray-900 focus:outline-none focus:ring-blue-400 dark:bg-dark-bg dark:hover:bg-gray-700 dark:focus:border-dark-bg dark:focus:bg-MITRE-light-silver dark:focus:ring-dark-bg sm:text-sm"
                    placeholder="Search"
                    type="search"
                  />
                </div>
            ...
            <PopoverButton
              class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 dark:bg-dark-bg"
            >
          ...
          <PopoverGroup as="nav" class="hidden space-x-7 md:flex xl:space-x-10">
            <Popover v-slot="{open}" class="relative">
              <PopoverButton
                :class="[
                  ...
                  'group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:bg-dark-bg dark:hover:text-gray-200'
                ]"
              >
                <span>Toolkit</span>
                <ChevronDownIcon
              ...
              >
                ...
                >
                  <div
                    class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 dark:ring-gray-500"
                  >
                    <div
                      class="relative grid gap-6 bg-white px-5 py-6 dark:bg-dark-bg sm:gap-8 sm:p-8"
                    >
                      <NuxtLink
                        v-for="item in toolkit"
                        :key="item.name"
                        :to="item.href"
                        class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700"
                      >
                        <component
                          :is="item.icon"
                        ...
                        <div class="ml-4">
                          <p
                            class="text-base font-medium text-gray-900 dark:text-MITRE-silver"
                          >
                            {{ item.name }}
                          </p>
                    ...
                    <div
                      class="space-y-6 bg-gray-50 px-5 py-5 dark:bg-dark-bg sm:flex sm:space-y-0 sm:space-x-10 sm:px-8"
                    >
                      <div
                      ...
                      >
                        <a
                          :href="item.href"
                          class="-m-3 flex items-center rounded-md p-3 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-MITRE-silver"
                        >
                          <component
                            :is="item.icon"
            ...
            <NuxtLink
              to="/blog"
              class="text-base font-medium text-gray-500 hover:text-gray-900 dark:text-dark-text dark:hover:text-gray-200"
            >
              Blog
            </NuxtLink>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="ml-4">
                          ...
                          <p
                            class="mt-1 text-sm text-gray-500 dark:text-dark-text"
                          >
                            {{ item.description }}
                          </p>
                        </div>
                    ...
                    <div
                      class="bg-gray-50 px-5 py-5 dark:bg-dark-bg sm:px-8 sm:py-8"
                    >
                      <div>
                        <h3
                        ...
                        <ul role="list" class="mt-4 space-y-4">
                          ...
                          >
                            <a
                              :href="post.href"
                              class="font-medium text-gray-900 hover:text-gray-700 dark:text-MITRE-silver"
                            >
                              {{ post.name }}
                            </a>
                          </li>
          ...
          <div
            class="hidden flex-1 items-center justify-end pr-2 md:flex md:w-0"
          >
            <div class="hidden flex-1 items-center justify-end md:flex md:w-0">
            ...
            <div
              id="theme-toggle"
              type="button"
              class="rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-dark-text dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              <div class="relative flex items-center">
                ...
                <select
                  id="theme"
                  name="theme"
                  class="absolute h-fit w-full appearance-none pr-3 opacity-0 dark:bg-slate-600 dark:text-white"
      ...
      >
        <div class="fixed top-4 right-4 z-50 w-full max-w-xs px-6">
          <PopoverOverlay
            class="fixed inset-0 z-auto bg-black/20 backdrop-blur-sm dark:bg-slate-900/80"
          />
          <PopoverPanel focus class="fixed w-full max-w-xs px-6">
            <div
              class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-dark-bg dark:ring-gray-500"
            >
                ...
                <div class="my-3">
                  <nav class="grid gap-y-8">
                    <NuxtLink
                      ...
                      :key="item.name"
                      :to="item.href"
                      class="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50 dark:hover:bg-gray-700"
                    >
                      <component
                        :is="item.icon"
                        class="h-6 w-6 flex-shrink-0 text-blue-600"
                      ...
                      />
                      <span
                        class="ml-3 text-base font-medium text-gray-900 dark:text-MITRE-silver"
                      >
                        {{ item.name }}
                      </span>
                    </NuxtLink>
...
export default {
  ...
  methods: {
    ...
    hideBanner() {
      const bannerDIV = document.getElementById('newsBannerDIV');
