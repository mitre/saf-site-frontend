<template>
  <div>
    <!-- Guidance Content -->
    <div class="mx-auto mt-8 max-w-5xl overflow-hidden bg-neutral-2 shadow sm:rounded-lg">
      ...
      <div class="font-semibold sm:flex">
        <div class="flex-1 border-t border-accent">
          <div>
            <div class="flex grid-cols-3 flex-col gap-4 border-b bg-neutral-1 px-4 py-5 sm:grid">
              <span class="underline sm:no-underline">Category</span>
              <span class="mt-1 sm:col-span-2 sm:mt-0">{{ guidance.category.replaceAll('_', ' ') }}
              </span>
            </div>
            <div class="flex grid-cols-3 flex-col gap-4 border-b bg-neutral-2 px-4 py-5 sm:grid">
            ...
            <div class="flex grid-cols-3 flex-col gap-4 border-b bg-neutral-1 px-4 py-5 sm:grid">
              ...
              <span v-if="guidance.version != 0" class="mt-1 sm:col-span-2 sm:mt-0">{{ guidance.version }}</span>
            ...
            <div class="flex grid-cols-3 flex-col gap-4 border-b bg-neutral-2 px-4 py-5 sm:grid">
              ...
              <a class="hover:text-nav-light-active dark:hover:text-nav-dark-active mt-1 flex items-center after:content-['_↗'] hover:underline sm:col-span-2 sm:mt-0"
      ...
      <div class="overflow-hidden border-t-2 border-accent bg-neutral-2 shadow">
        ...
        <div class="border-b-2 border-neutral-1 bg-neutral-2 px-4 py-5 sm:flex sm:gap-4 sm:px-6">
          <div class="flex-1">
        ...
        <div class="h-full font-semibold sm:flex md:max-h-96">
          <div v-if="guidance.hardening != null" class="flex-1 overflow-y-scroll border-r-2 border-neutral-1">
            <div v-for="hardening in guidance.hardening" :key="hardening.name">
              <div class="border-b bg-neutral-1 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-3 sm:px-6">
              ...
              <div class="border-b bg-neutral-2 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                ...
                <div class="flex items-center">
                  ...
                  <a class="hover:text-nav-light-active dark:hover:text-nav-dark-active ml-3 mt-1 hover:underline sm:col-span-2 sm:mt-0"
                    target="_blank" :href="hardening.platform.link">{{ hardening.platform.name }}</a>
                </div>
              </div>
              <div class="border-b bg-neutral-1 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
              ...
              <div class="border-b bg-neutral-2 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-3 sm:px-6">
                <span class="flex items-center underline sm:no-underline">Last Updated </span>
                <div class="flex items-center">
                  <span class="mt-1 sm:col-span-2 sm:ml-3 sm:mt-0">
              ...
              <div class="border-b-4 border-accent bg-neutral-1 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                <span class="flex items-center underline sm:no-underline">Link</span>
                <a class="hover:text-nav-light-active dark:hover:text-nav-dark-active mt-1 inline-block items-center break-all after:content-['_↗'] hover:underline sm:col-span-1 sm:mt-0"
          ...
          <div class="flex-1 overflow-y-auto border-r-2 border-neutral-1">
            ...
            <div v-if="guidance.validation != null">
              <div v-for="validation in guidance.validation" :key="validation.name" class="overflow-y-scroll">
                <div class="border-b bg-neutral-1 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                  <span class="flex items-center underline sm:no-underline">Name</span>
                  <div class="flex items-center">
                    <span class="mt-1 sm:col-span-2 sm:ml-3 sm:mt-0">
