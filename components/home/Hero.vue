<template>
  <div class="bg-neutral-1  pt-12 px-6">
    <main>
      <h1 class="text-3xl tracking-tight font-extrabold text-header  sm:text-5xl md:text-6xl text-center">
        <span class="block xl:inline">MITRE Security Automation Framework</span>
      </h1>
      <div class="relative py-24 lg:pb-40">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-5xl">
            <h2 class="text-2xl font-bold tracking-tight text-header  sm:text-4xl">Automate
              activities across your pipeline</h2>
            <p class="mt-6 text-lg leading-8 text-base ">MITRE SAF supports security processes at
